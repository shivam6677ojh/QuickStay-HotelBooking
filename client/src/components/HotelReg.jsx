                ...
                <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                    ...
                    <div className='w-full mt-4'>
                        ...
                        <select id="city" className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light required">
                            {/* <option> elements go here </option> */}
                    ...
                    <button className='px-6 py-3 mt-6 bg-blue-600 cursor-pointer text-white text-sm font-medium rounded-lg shadow hover:bg-blue-700 transition-all duration-200 active:scale-95'>
                            Register
                    </button>
